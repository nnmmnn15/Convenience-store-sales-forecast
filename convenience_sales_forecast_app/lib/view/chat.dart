...
class Chat extends StatelessWidget {
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () async {
                  ...
                  await chatsHandler
                      .queryChat(chatsHandler.currentRoomId.value);
                      ...
                      child: SizedBox(
                        ...
                        child: Card(
                          ...
                          shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(
                              color:
                                  chatsHandler.selectedChatIndex.value == index
                  ...
                  : [
                      Padding(
                        ...
                        child: SizedBox(
                            child: index > 0
                                ? chat.sender ==
                                        chatsHandler.chats[index - 1].sender
                                    ? int.parse(chat.timestamp
                                                .substring(14, 16)) ==
                                            int.parse(chatsHandler
                                    ...
                                    : CircleAvatar(
                                        backgroundImage: NetworkImage(
                                            chatsHandler.getUserImageByEmail(
                                                chatsHandler.users,
                                                chat.sender)!),
                                        radius: 35,
                                      )
                                : CircleAvatar(
                                    backgroundImage: NetworkImage(
                                        chatsHandler.getUserImageByEmail(
                                            chatsHandler.users, chat.sender)!),
                                    radius: 35,
                                  )),
                      ),
                      Padding(
                                  ...
                                  ? chat.sender ==
                                      ...
                                      ? int.parse(chat.timestamp
                                              ...
                                              int.parse(chatsHandler
                                                  ...
                                                  .substring(14, 16))
                                          ? Text(
                                              chatsHandler.getUserNameByEmail(
                                                  chatsHandler.users,
                                                  chat.sender)!,
                                              style:
  ...
  inputChat() async {
    ...
    ChatList newChat = ChatList(
        ...
        sender: userHandler.box.read('userEmail'),
        roomId: chatsHandler.currentRoomId.value);
